...
def run_cli():
    ...
    parser = argparse.ArgumentParser(
        description="OPERADAR",
        formatter_class=argparse.RawDescriptionHelpFormatter,
        usage="python3 -m operadar [-h] [--append] [--verbose] filename config")
    parser.add_argument("filename", type=str, help="Only the name of the input file, not the entire path. Use the config file to provide the path to access the file.")
